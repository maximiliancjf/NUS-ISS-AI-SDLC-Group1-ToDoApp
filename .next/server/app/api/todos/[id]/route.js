(()=>{var a={};a.id=885,a.ids=[885],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},615:(a,b,c)=>{"use strict";c.d(b,{Ve:()=>z,as:()=>o,VZ:()=>u,Xu:()=>E,py:()=>i,Ay:()=>I,V8:()=>s,_R:()=>y,I7:()=>G,Ys:()=>l,mn:()=>C,z1:()=>D,Es:()=>p,bi:()=>q,nP:()=>v,Sm:()=>w,Ji:()=>B,nB:()=>F,Nr:()=>j,Ps:()=>m,B:()=>H,hv:()=>A,pC:()=>n,lb:()=>r,Gw:()=>x,uy:()=>k});let d=require("better-sqlite3");var e=c.n(d),f=c(9902),g=c.n(f);let h=new(e())(g().join(process.cwd(),"todos.db"));function i(a,b,c,d="medium"){return j(h.prepare(`
  ...
  `).all(a).map(a=>({...a,subtasks:q(a.id)||[],tags:B(a.id)||[]}))}function D(a="demo-user"){let b=h.prepare("SELECT id, username FROM users WHERE username = ?"),c=b.get(a);return c||(c={id:(b=h.prepare("INSERT INTO users (username) VALUES (?)")).run(a).lastInsertRowid,username:a}),c}function E(a,b,c,d,e,f,g){return h.prepare(`
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?)
  `).run(a,b,c,d,e,f,g).lastInsertRowid}function F(a){return h.prepare("SELECT * FROM templates WHERE user_id = ? ORDER BY created_at DESC").all(a)}function G(a){h.prepare("DELETE FROM templates WHERE id = ?").run(a)}function H(a,b,c){let d=h.prepare("SELECT * FROM templates WHERE id = ?").get(a);if(!d)throw Error("Template not found");let e=i(b,`Todo from ${d.name}`,c,d.priority,null,null,null);if(d.subtasks_json)try{for(let a of JSON.parse(d.subtasks_json))o(e,a.title)}catch(a){console.error("Failed to parse subtasks JSON:",a)}if(d.tag_ids_json)try{for(let a of JSON.parse(d.tag_ids_json))z(e,a)}catch(a){console.error("Failed to parse tag IDs JSON:",a)}return e}let I=h},846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},3033:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3295:a=>{"use strict";a.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},4870:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6439:a=>{"use strict";a.exports=require("next/dist/shared/lib/no-fallback-error.external")},6487:()=>{},8335:()=>{},9121:a=>{"use strict";a.exports=require("next/dist/server/app-render/action-async-storage.external.js")},9294:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-async-storage.external.js")},9603:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>D,patchFetch:()=>C,routeModule:()=>y,serverHooks:()=>B,workAsyncStorage:()=>z,workUnitAsyncStorage:()=>A});var d={};c.r(d),c.d(d,{DELETE:()=>x,PATCH:()=>w});var e=c(5736),f=c(9117),g=c(4044),h=c(9326),i=c(2324),j=c(261),k=c(4290),l=c(5328),m=c(8928),n=c(6595),o=c(3421),p=c(7679),q=c(1681),r=c(3446),s=c(6439),t=c(1356),u=c(641),v=c(615);async function w(a,{params:b}){try{let{id:d}=await b,e=await a.json(),f=(0,v.Nr)(parseInt(d));if(!f)return u.NextResponse.json({error:"Todo not found"},{status:404});if(1===e.completed&&f.recurrence_pattern&&!f.completed){let a,b=(0,v.z1)(),d=new Date(f.due_date);switch(f.recurrence_pattern){case"daily":a=new Date(d.setDate(d.getDate()+1));break;case"weekly":a=new Date(d.setDate(d.getDate()+7));break;case"monthly":a=new Date(d.setMonth(d.getMonth()+1));break;case"yearly":a=new Date(d.setFullYear(d.getFullYear()+1));break;default:a=d}let e=(0,v.py)(b.id,f.title,a.toISOString(),f.priority);for(let a of(c(615).Ay.prepare("UPDATE todos SET recurrence_pattern = ? WHERE id = ?").run(f.recurrence_pattern,e.id),(0,v.bi)(f.id)))(0,v.as)(e.id,a.title);for(let a of(0,v.Ji)(f.id))(0,v.Ve)(e.id,a.id)}let g=(0,v.uy)(parseInt(d),e);return u.NextResponse.json(g)}catch(a){return console.error("Error updating todo:",a),u.NextResponse.json({error:"Failed to update todo"},{status:500})}}async function x(a,{params:b}){try{let{id:a}=await b;if(!(0,v.Ys)(parseInt(a)))return u.NextResponse.json({error:"Todo not found"},{status:404});return u.NextResponse.json({success:!0})}catch(a){return console.error("Error deleting todo:",a),u.NextResponse.json({error:"Failed to delete todo"},{status:500})}}let y=new e.AppRouteRouteModule({definition:{kind:f.RouteKind.APP_ROUTE,page:"/api/todos/[id]/route",pathname:"/api/todos/[id]",filename:"route",bundlePath:"app/api/todos/[id]/route"},distDir:".next",relativeProjectDir:"",resolvedPagePath:"C:\\Users\\dy\\Desktop\\githubcopilot\\NUS-ISS-AI-SDLC-Group1-ToDoApp\\app\\api\\todos\\[id]\\route.ts",nextConfigOutput:"",userland:d}),{workAsyncStorage:z,workUnitAsyncStorage:A,serverHooks:B}=y;function C(){return(0,g.patchFetch)({workAsyncStorage:z,workUnitAsyncStorage:A})}async function D(a,b,c){var d;let e="/api/todos/[id]/route";"/index"===e&&(e="/");let g=await y.prepare(a,b,{srcPage:e,multiZoneDraftMode:!1});if(!g)return b.statusCode=400,b.end("Bad Request"),null==c.waitUntil||c.waitUntil.call(c,Promise.resolve()),null;let{buildId:u,params:v,nextConfig:w,isDraftMode:x,prerenderManifest:z,routerServerContext:A,isOnDemandRevalidate:B,revalidateOnlyGenerated:C,resolvedPathname:D}=g,E=(0,j.normalizeAppPath)(e),F=!!(z.dynamicRoutes[E]||z.routes[D]);if(F&&!x){let a=!!z.routes[D],b=z.dynamicRoutes[E];if(b&&!1===b.fallback&&!a)throw new s.NoFallbackError}let G=null;!F||y.isDev||x||(G="/index"===(G=D)?"/":G);let H=!0===y.isDev||!F,I=F&&!H,J=a.method||"GET",K=(0,i.getTracer)(),L=K.getActiveScopeSpan(),M={params:v,prerenderManifest:z,renderOpts:{experimental:{cacheComponents:!!w.experimental.cacheComponents,authInterrupts:!!w.experimental.authInterrupts},supportsDynamicResponse:H,incrementalCache:(0,h.getRequestMeta)(a,"incrementalCache"),cacheLifeProfiles:null==(d=w.experimental)?void 0:d.cacheLife,isRevalidate:I,waitUntil:c.waitUntil,onClose:a=>{b.on("close",a)},onAfterTaskError:void 0,onInstrumentationRequestError:(b,c,d)=>y.onRequestError(a,b,d,A)},sharedContext:{buildId:u}},N=new k.NodeNextRequest(a),O=new k.NodeNextResponse(b),P=l.NextRequestAdapter.fromNodeNextRequest(N,(0,l.signalFromNodeResponse)(b));try{let d=async c=>y.handle(P,M).finally(()=>{if(!c)return;c.setAttributes({"http.status_code":b.statusCode,"next.rsc":!1});let d=K.getRootSpanAttributes();if(!d)return;if(d.get("next.span_type")!==m.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${d.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let e=d.get("next.route");if(e){let a=`${J} ${e}`;c.setAttributes({"next.route":e,"http.route":e,"next.span_name":a}),c.updateName(a)}else c.updateName(`${J} ${a.url}`)}),g=async g=>{var i,j;let k=async({previousCacheEntry:f})=>{try{if(!(0,h.getRequestMeta)(a,"minimalMode")&&B&&C&&!f)return b.statusCode=404,b.setHeader("x-nextjs-cache","REVALIDATED"),b.end("This page could not be found"),null;let e=await d(g);a.fetchMetrics=M.renderOpts.fetchMetrics;let i=M.renderOpts.pendingWaitUntil;i&&c.waitUntil&&(c.waitUntil(i),i=void 0);let j=M.renderOpts.collectedTags;if(!F)return await (0,o.I)(N,O,e,M.renderOpts.pendingWaitUntil),null;{let a=await e.blob(),b=(0,p.toNodeOutgoingHttpHeaders)(e.headers);j&&(b[r.NEXT_CACHE_TAGS_HEADER]=j),!b["content-type"]&&a.type&&(b["content-type"]=a.type);let c=void 0!==M.renderOpts.collectedRevalidate&&!(M.renderOpts.collectedRevalidate>=r.INFINITE_CACHE)&&M.renderOpts.collectedRevalidate,d=void 0===M.renderOpts.collectedExpire||M.renderOpts.collectedExpire>=r.INFINITE_CACHE?void 0:M.renderOpts.collectedExpire;return{value:{kind:t.CachedRouteKind.APP_ROUTE,status:e.status,body:Buffer.from(await a.arrayBuffer()),headers:b},cacheControl:{revalidate:c,expire:d}}}}catch(b){throw(null==f?void 0:f.isStale)&&await y.onRequestError(a,b,{routerKind:"App Router",routePath:e,routeType:"route",revalidateReason:(0,n.c)({isRevalidate:I,isOnDemandRevalidate:B})},A),b}},l=await y.handleResponse({req:a,nextConfig:w,cacheKey:G,routeKind:f.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:z,isRoutePPREnabled:!1,isOnDemandRevalidate:B,revalidateOnlyGenerated:C,responseGenerator:k,waitUntil:c.waitUntil});if(!F)return null;if((null==l||null==(i=l.value)?void 0:i.kind)!==t.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==l||null==(j=l.value)?void 0:j.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});(0,h.getRequestMeta)(a,"minimalMode")||b.setHeader("x-nextjs-cache",B?"REVALIDATED":l.isMiss?"MISS":l.isStale?"STALE":"HIT"),x&&b.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let m=(0,p.fromNodeOutgoingHttpHeaders)(l.value.headers);return(0,h.getRequestMeta)(a,"minimalMode")&&F||m.delete(r.NEXT_CACHE_TAGS_HEADER),!l.cacheControl||b.getHeader("Cache-Control")||m.get("Cache-Control")||m.set("Cache-Control",(0,q.getCacheControlHeader)(l.cacheControl)),await (0,o.I)(N,O,new Response(l.value.body,{headers:m,status:l.value.status||200})),null};L?await g(L):await K.withPropagatedContext(a.headers,()=>K.trace(m.BaseServerSpan.handleRequest,{spanName:`${J} ${a.url}`,kind:i.SpanKind.SERVER,attributes:{"http.method":J,"http.target":a.url}},g))}catch(b){if(b instanceof s.NoFallbackError||await y.onRequestError(a,b,{routerKind:"App Router",routePath:E,routeType:"route",revalidateReason:(0,n.c)({isRevalidate:I,isOnDemandRevalidate:B})}),F)throw b;return await (0,o.I)(N,O,new Response(null,{status:500})),null}}},9902:a=>{"use strict";a.exports=require("path")}};var b=require("../../../../webpack-runtime.js");b.C(a);var c=b.X(0,[331,692],()=>b(b.s=9603));module.exports=c})();